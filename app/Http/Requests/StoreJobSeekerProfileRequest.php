...
class StoreJobSeekerProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'education_level' => ['required', 'string', Rule::in(self::EDUCATION_LEVELS)],
            ...
            'id_document_front_file' => [Rule::requiredIf(fn () => ! $this->user()?->jobSeekerProfile?->id_document_front_file), 'nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240'],
            'id_document_back_file' => [Rule::requiredIf(fn () => ! $this->user()?->jobSeekerProfile?->id_document_back_file), 'nullable', 'image', 'mimes:jpg,jpeg,png,webp', 'max:10240'],
