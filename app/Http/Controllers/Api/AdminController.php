    ...
    public function stats()
    {
        return response()->json([
            'data' => [
                ...
                'job_seekers_pending' => User::query()->where('role', 'job_seeker')->where('status', 'pending')->count(),
                'job_seekers_approved' => User::query()->where('role', 'job_seeker')->where('status', 'approved')->count(),
                'total_employers' => User::query()->where('role', 'employer')->count(),
                'employers_pending' => User::query()->where('role', 'employer')->where('status', 'pending')->count(),
                'employers_approved' => User::query()->where('role', 'employer')->where('status', 'approved')->count(),
